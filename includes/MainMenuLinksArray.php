...
$MenuItems['Sales']['Transactions']['Caption'] = array(_('New Reservation'), _('Reservation Approval') ,_('Enter Counter Sales'), _('Enter Counter Returns'), _('Generate/Print Picking Lists'), _('Outstanding Sales Orders/Quotations'), _('Special Order'), _('Recurring Order Template'), _('Process Recurring Orders'), _('Maintain Picking Lists'));
$MenuItems['Sales']['Transactions']['URL'] = array('/NewReservation.php?NewOrder=Yes', '/ReservationApproval.php' , '/CounterSales.php', '/CounterReturns.php', '/GeneratePickingList.php', '/SelectSalesOrder.php', '/SpecialOrder.php', '/SelectRecurringSalesOrder.php', '/RecurringSalesOrdersProcess.php', '/SelectPickingLists.php');
...
$MenuItems['Sales']['Maintenance']['Caption'] = array(_('Create Contract'), _('Select Contract'), _('Sell Through Support Deals'), _('Create New Reservation Approval'), _('Driver Maintenance'), _('Vehicle Maintenance'), ); // New menu item
$MenuItems['Sales']['Maintenance']['URL'] = array('/Contracts.php', '/SelectContract.php', '/SellThroughSupport.php', '/NewReservationApproval.php', '/DriverMaintenance.php', '/VehicleMaintenance.php'); // New menu item
$MenuItems['Sales']['Maintenance']['URL'] = array('/Contracts.php', '/SelectContract.php', '/SellThroughSupport.php', '/NewReservationApproval.php', '/DriverMaintenance.php', '/VehicleMaintenance.php'); // New menu item
...
$MenuItems['AR']['Reports']['URL'] = array('/CustWhereAlloc.php', $PrintInvoicesOrCreditNotesScript, '/PrintCustStatements.php', '/AgedDebtors.php', '/PDFBankingSummary.php', '/DebtorsAtPeriodEnd.php', '/PDFCustomerList.php', '/PDFCustTransListing.php', '/CustomerTransInquiry.php', '/CustomerBalancesMovement.php', '/CustomerStatementBalances.php');
...
$MenuItems['GL']['Transactions']['Caption'] = array(_('Bank Transfer'), _('Bank Account Payments Entry'), _('Bank Account Receipts Entry'), _('Import Bank Transactions'), _('Bank Account Payments Matching'), _('Bank Account Receipts Matching'), _('Journal Entry'));
$MenuItems['GL']['Transactions']['URL'] = array('/BankTransfer.php', '/Payments.php?NewPayment=Yes', '/CustomerReceipt.php?NewReceipt=Yes&amp;Type=GL', '/ImportBankTrans.php', '/BankMatching.php?Type=Payments', '/BankMatching.php?Type=Receipts', '/GLJournal.php?NewJournal=Yes');
...
$MenuItems['system']['Reports']['Caption'] = array(_('Sales Types'), _('Customer Types'), _('Supplier Types'), _('Credit Status'), _('Payment Terms'), _('Set Purchase Order Authorisation levels'), _('Payment Methods'), _('Supervisor'), _('Sales Areas'), _('Shippers'), _('Sales GL Interface Postings'), _('COGS GL Interface Postings'), _('Freight Costs Maintenance'), _('Discount Matrix'));
$MenuItems['system']['Reports']['URL'] = array('/SalesTypes.php', '/CustomerTypes.php', '/SupplierTypes.php', '/CreditStatus.php', '/PaymentTerms.php', '/PO_AuthorisationLevels.php', '/PaymentMethods.php', '/Supervisor.php', '/Areas.php', '/Shippers.php', '/SalesGLPostings.php', '/COGSGLPostings.php', '/FreightCosts.php', '/DiscountMatrix.php');
...
$MenuItems['Utilities']['Maintenance']['Caption'] = array(_('Maintain Language Files'), _('Make New Company'), _('Data Export Options'), _('Import Customers from .csv file'), _('Import Stock Items from .csv file'), _('Import Price List from .csv file'), _('Import Fixed Assets from .csv file'), _('Import GL Payments Receipts Or Journals From .csv file'), _('Create new company template SQL file and submit to SavageERP'), _('Re-calculate brought forward amounts in GL'), _('Re-Post all GL transactions from a specified period'), _('Purge all old prices'), _('Remove all purchase back orders'));
