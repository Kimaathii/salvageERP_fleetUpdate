...
$MenuItems['Sales']['Transactions']['Caption'] = array(_('New Reservation'), _('Enter Counter Sales'), _('Enter Counter Returns'), _('Generate/Print Picking Lists'), _('Outstanding Sales Orders/Quotations'), _('Special Order'), _('Recurring Order Template'), _('Process Recurring Orders'), _('Maintain Picking Lists'));
$MenuItems['Sales']['Transactions']['URL'] = array('/NewReservation.php?NewOrder=Yes', '/CounterSales.php', '/CounterReturns.php', '/GeneratePickingList.php', '/SelectSalesOrder.php', '/SpecialOrder.php', '/SelectRecurringSalesOrder.php', '/RecurringSalesOrdersProcess.php', '/SelectPickingLists.php');
...
$MenuItems['Sales']['Maintenance']['Caption'] = array(_('Create Contract'), _('Select Contract'), _('Sell Through Support Deals'), _('Driver Maintenance'), _('Vehicle Maintenance'), _('New Reservation Approval')); // New menu item
$MenuItems['Sales']['Maintenance']['URL'] = array('/Contracts.php', '/SelectContract.php', '/SellThroughSupport.php', '/DriverMaintenance.php', '/VehicleMaintenance.php', '/NewReservationApproval.php'); // New menu item
$MenuItems['Sales']['Maintenance']['URL'] = array('/Contracts.php', '/SelectContract.php', '/SellThroughSupport.php', '/DriverMaintenance.php', '/VehicleMaintenance.php', '/NewReservationApproval.php'); // New menu item
