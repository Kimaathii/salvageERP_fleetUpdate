				...
				<div class="table-responsive">
					...
					<form action="' . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES, 'UTF-8') . '?identifier=' . urlencode($identifier) . '" method="post">
						<div>
							...
							<table cellpadding="3" class="selection table">
								<tr>
									<td>Part of the Customer Branch Code:</td>
									<td>
										<input type="text" name="CustCode" size="15" maxlength="18"
											title="Enter a part of a customer code that you wish to search for then click the Search Now button to find matching customers" />
									</td>
									<td><b>OR</b></td>
									<td>Part of the Customer Branch Name:</td>
									<td>
										<input type="text" autofocus="autofocus" name="CustKeywords" size="20" maxlength="25"
											title="Enter a text extract of the customer\'s name, then click Search Now to find customers matching the entered name" />
									</td>
									<td><b>' . _('OR') . '</b></td>
									<td>' . _('Part of the Branch Phone Number') . ':</td>
									<td>
										<input type="text" name="CustPhone" size="15" maxlength="18"
											title="' . _('Enter a part of a customer\'s phone number that you wish to search for then click the Search Now button to find matching customers') . '" />
									</td>
								</tr>
							</table>
							<div class="centre">
								<input class="btn btn-primary" type="submit" name="SearchCust" value="Search Now" />
