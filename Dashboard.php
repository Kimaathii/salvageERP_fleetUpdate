...
<div class="card-header"
	style="padding-left:0 !important; margin-left:0;  background:none !important; margin-bottom:10px; border-top:none !important">
	<i class="header-icon lnr-gift icon-gradient bg-mixed-hopes">
	</i> Overdue Customer Balances

</div>
<div class="row">
	<div class="col-md-6 col-lg-4">
		<div
			class="widget-chart widget-chart2 text-left card-btm-border card-shadow-primary border-primary card">
			<div class="widget-chat-wrapper-outer">
				<div class="widget-chart-content">
					<div class="widget-title opacity-5 text-uppercase">Total Cust. Balances</div>
					<div class="widget-numbers mt-2 fsize-4 mb-0 w-100">
						<div class="widget-chart-flex align-items-center">
							<div style="font-size:15px"><?php echo locale_number_format($TotBal, $CurrDecimalPlaces) ?></div>
							<div class="widget-title ml-auto font-size-lg font-weight text-primary">
								<small><span class="pr-1"> <i
											class="fa fa-angle-down"></i></span><br />100% </small>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="col-md-6 col-lg-3">
		<div
			class="widget-chart widget-chart2 text-left card-btm-border card-shadow-danger border-danger card">
			<div class="widget-chat-wrapper-outer">
				<div class="widget-chart-content">
					<div class="widget-title opacity-5 text-uppercase">Total Current Overdue</div>
					<div class="widget-numbers mt-2 fsize-4 mb-0 w-100">
						<div class="widget-chart-flex align-items-center">
							<div style="font-size:15px"><?php echo locale_number_format($TotDue, $CurrDecimalPlaces) ?></div>
							<div class="widget-title ml-auto font-size-lg font-weight text-danger">
								<small><span class="pr-1"> <i
											class="fa fa-angle-down"></i></span><br /><?php echo number_format($percentDue, 2) ?>%</small>
							</div>
						</div>
					</div>
				</div>
	...
	<div class="col-md-6 col-lg-3">
		<div
			class="widget-chart widget-chart2 text-left card-btm-border card-shadow-warning border-warning card">
			<div class="widget-chat-wrapper-outer">
				<div class="widget-chart-content">
					<div class="widget-title opacity-5 text-uppercase">Total 60 Days Overdue</div>
					<div class="widget-numbers mt-2 fsize-4 mb-0 w-100">
						<div class="widget-chart-flex align-items-center">
							<div style="font-size:15px"><?php echo locale_number_format($TotOD2, $CurrDecimalPlaces) ?></div>
							<div class="widget-title ml-auto font-size-lg font-weight text-warning">
								<small><span class="pr-1"> <i
											class="fa fa-angle-up"></i></span><br /><?php echo number_format($percentOD2, 2) ?>%</small>
							</div>
	...
	<div class="col-md-6 col-lg-2">
		<a href="/Dashboard_CustomerReport.php" style="padding-bottom:25px"
			class="mb-2 mr-2 btn-icon-vertical btn btn-primary"><i
				class="pe-7s-gym btn-icon-wrapper"> </i> View full Report</button></a>
	</div>
...
if (in_array($DebtorSecurity, $_SESSION['AllowedPageSecurityTokens']) or !isset($DebtorSecurity)) {
	echo '
		<h2 class="text-muted text-uppercase font-size-md opacity-7 mb-3 font-weight-normal">', _('Overdue Customer Balances'), '</h2>
	...
	while ($AgedAnalysis = DB_fetch_array($CustomerResult)) {
		...
		if ($DisplayDue <> 0 or $DisplayOverdue1 <> 0 or $DisplayOverdue2 <> 0) {
			...
			echo '<tr class="striped_row">
					<td class="text" colspan="4"><a href="CustomerInquiry.php?CustomerID=', $AgedAnalysis['debtorno'], '"><b>', $AgedAnalysis['debtorno'], ' - ', $AgedAnalysis['name'], '</b></a></td>
...
if (in_array($PayeeSecurity, $_SESSION['AllowedPageSecurityTokens']) or !isset($PayeeSecurity)) {
	...
	<div class="card-body">
		<h2 class="text-muted text-uppercase font-size-md opacity-7 mb-3 font-weight-normal">', _('Supplier Invoices Due within 1 Month'), '</h2>
		<div class="border-light card-border scroll-area-sm card">
		<table class="selection">
		<thead>
			<tr>
...
if (in_array($CashSecurity, $_SESSION['AllowedPageSecurityTokens']) or !isset($CashSecurity)) {
	...
	<div class="main-card mb-3 card">
	<div class="card-body">
		<h2 class="text-muted text-uppercase font-size-md opacity-7 mb-3 font-weight-normal">', _('Bank and Credit Card Balances'), '</h2>
		<div class="border-light card-border scroll-area-sm card">
		<table class="selection">
		<thead>
			<tr>
...
if (in_array($OrderSecurity, $_SESSION['AllowedPageSecurityTokens']) or !isset($OrderSecurity)) {
	...
	<div class="main-card mb-3 card">
	<div class="card-body">
		<h2 class="text-muted text-uppercase font-size-md opacity-7 mb-3 font-weight-normal">', _('Outstanding Orders'), '</h2>
		<div class="border-light card-border scroll-area-sm card">
		<table class="selection">
		<thead>', '<tr>
				<th>', _('View Order'), '</th>
