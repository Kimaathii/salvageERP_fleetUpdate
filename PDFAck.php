	...
	echo '<table class="table_index">
				<tr>
					<td class="menu_group_item">
						<ul><li><a href="' . $RootPath . '/SelectSalesOrder.php?Acknowledgements=Quotes_Only">' . _('WAY BILL') . '</a></li>
						</ul>
					</td>
				</tr>
				</table>';
...
$pdf->addInfo('Title', _('Customer Way'));
$pdf->addInfo('Subject', _('WAY BILL') . ' ' . $_GET['AcknowledgementNo']);
$FontSize = 12;
$PageNumber = 1;
