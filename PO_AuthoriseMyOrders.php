...
echo '<thead>
		...
		<th class="ascending">' . _('Inventory Location') . '</th>
...
while ($myrow = DB_fetch_array($result)) {
	// Query inventory location information
	$InventoryLocationSQL = "SELECT locationname FROM locations WHERE loccode='" . $myrow['location'] . "'";
	$InventoryLocationResult = DB_query($InventoryLocationSQL);
	$InventoryLocationRow = DB_fetch_array($InventoryLocationResult);
	$InventoryLocation = $InventoryLocationRow['locationname'];
	...
	if ($AuthLevel >= $OrderValue) {
		echo '<tr>
				...
				<td>' . locale_number_format($OrderValue, $myrow['currdecimalplaces']) . '</td>
			</tr>';
